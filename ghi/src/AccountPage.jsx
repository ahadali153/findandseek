                ...
                <>
                    <Row className="mt-4">
                        ...
                        <Card className="card-background">
                            <Card.Body>
                            <Card.Title className="text-center">Welcome to {userData?.email}'s Page!</Card.Title>
                            </Card.Body>
                        </Card>
                        </Col>
                    </Row>
                    <Row className="mt-4">
                        ...
                        <Card className="card-background">
                            <Card.Body>
                            <Card.Title className="text-center">User PFP: {userData.profile_picture}</Card.Title>
                            </Card.Body>
                        </Card>
                        </Col>
                    </Row>
                    <Row className="mt-4">
                        ...
                        <Card className="card-background">
                            <Card.Body>
                            <Card.Title className="text-center">Upload Profile Picture</Card.Title>
